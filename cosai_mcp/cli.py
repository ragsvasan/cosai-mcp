...
@click.option("--emit-to", "emit_to", default=None, envvar="COSAI_EMIT_TO",
              help="SIEM/SOAR webhook URL to emit OCSF Security Incident events.")
...
@click.option("--anomaly-threshold", type=int, default=10, show_default=True,
              help="Max findings before HIGH_FINDING_RATE containment fires.")
@click.option("--critical-burst-threshold", type=int, default=3, show_default=True,
              help="Max critical findings before CRITICAL_BURST containment fires.")
def scan(
    target: str,
    categories: str,
    engine: str,
